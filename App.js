  ...
  const setData = async()=> {
      ...
      function atualizarTexto(){
        ...
        return (
          ...
          <View style={styles.header}><Text style={{textAlign:'center',color:'white',fontSize:14}}>Aplicativo Anotação</Text></View>
           {
             (anotacao != '')?
      ...
      <View style={{flex:1}}>
              ...
              <View style={styles.header}><Text style={{textAlign:'center',color:'white',fontSize:14}}>Aplicativo Anotação</Text></View>
                ...
                <TextInput autoFocus={true} onChangeText={(text)=>setarAnotacao(text)} style={{padding:20,height:300,textAlignVertical:'top'}}multiline={true} numberOfLines={8} value={anotacao}></TextInput>
